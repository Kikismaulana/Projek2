...
| Izin | id_izin |  | Tabel preseni | Tabel izin terdiri dari id_izin int not null PRIMARY KEY DEFAULT NEXTVAL ('id_izin'), alasan text, tanggal_mulai date, tanggal_selesai date, bukti varchar(50), status varchar (10). tabel izin terhubung dengan tabel presensi |
